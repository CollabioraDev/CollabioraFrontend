                ...
                {step === STEP_EMAIL && (
                  ...
                  >
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                          {[
                            ...
                            <button
                              ...
                              className="py-3 rounded-lg border flex flex-col items-center justify-center gap-1.5 transition hover:bg-gray-50 disabled:opacity-50 bg-white"
                              style={{
                                borderColor: "#D0C4E2",
                                color: "#2F3C96",
                              }}
                    ...
                    <div className="flex gap-3 pt-2">
                      ...
                      <Button
                        onClick={() =>
                          canGoNextFromEmail && goToStep(STEP_NAME)
                        }
