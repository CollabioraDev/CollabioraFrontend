  ...
  >
    <div className="flex items-start gap-2">
      ...
      <button
        ...
        className="mt-0.5 rounded-lg p-1.5 text-slate-400 hover:bg-white hover:text-red-500 disabled:cursor-not-allowed disabled:opacity-40"
...
export default function YoriAI() {
  ...
  const defaultQuestions = useMemo(() => {
    ...
    questions.push(
      ...
      "What all can I do on Collabiora?",
    );
    return questions;
            ...
            <div className="flex-1 overflow-y-auto px-3 pb-3 space-y-1.5">
              {chatSessions.map((session) => (
                <ChatHistoryItem
                  ...
                  onDelete={deleteChat}
                  disableDelete={chatSessions.length <= 1}
                />
              ))}
            </div>
            ...
            {!hasUserMessages ? (
              <div className="flex min-h-full flex-col items-center justify-center px-2 pb-6 sm:pb-10">
                <div className="text-center mb-6 sm:mb-8 yori-section-enter yori-delay-1">
                  ...
                  <p className="mt-1 text-sm sm:text-base text-[#787878]">
