          ...
          >
            ...
            <p className="text-sm text-slate-600 flex items-center justify-center gap-2">
              {isResearcher && isSignedIn
                ...
                : "Connect with medical researchers worldwide"}
              <button
                type="button"
                onClick={() => {
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      className="bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-700 hover:to-indigo-800 text-white px-6 py-2.5 rounded-lg shadow-md hover:shadow-lg transition-all text-sm font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {findExpertLoading ? (
