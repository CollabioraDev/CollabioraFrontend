...
import ScrollToTop from "../dashboard-shared/ScrollToTop.jsx";
import VerifyEmailModal from "../dashboard-shared/VerifyEmailModal.jsx";
  ...
  return (
    <div className="min-h-scren relative ">
      ...
      <div className="px-4 sm:px-6 md:px-8 lg:px-12 mx-auto max-w-7xl pt-14 pb-12 relative rounded-t-3xl bg-[#F7F8FC] sm:bg-transparent">
        ...
        <div className="mt-6 mb-8" data-tour="dashboard-welcome">
